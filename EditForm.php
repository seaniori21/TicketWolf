...
<div class='header-wide-container'>
    ...
    <?php if ($ticket_data): ?>
        ...
        <div class='info-container' style='display:flex; flex-direction:row; gap:50px; padding:10px; border-bottom:1px solid grey'>
                        ...
                        <div><strong>Record Date:</strong> <?php echo htmlspecialchars($ticket_data['uploaded_at']); ?></div>
        </div>
        ...
        <form method="POST" action="functions/edit_form_id.php?form_id=<?php echo htmlspecialchars($ticket_data['form_id']); ?>">
                ...
                <div class='info-container'>
                    ...
                    <ul>
                        ...
                        <li><strong>Phone:</strong> 
                            <input type="text" name="phone" value="<?php echo htmlspecialchars($ticket_data['phone']); ?>" />
                        </li>
                    </ul>
                </div>
